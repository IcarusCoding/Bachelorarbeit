...
\begin{description}
	\item Die \texttt{\textbf{Subjekt}} Schnittstelle ...
	\item Die \texttt{\textbf{Beobachter}} Schnittstelle ...
	\item Die \texttt{\textbf{KonkretesSubjekt}}? Klasse ...
	\item Die \texttt{\textbf{KonkreterBeobachter}}? Klasse ...
\end{description}
\subsection{\ac{mvc}}
\section{JavaFX}
\label{javafx}
