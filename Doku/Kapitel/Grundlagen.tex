...
\begin{description}
	...
	\item Der \texttt{\textbf{View}} stellt die Anwendung visuell dar, ermöglicht eine Interaktion mit dieser und ist in den meisten Applikationen äquivalent zu einer grafischen Benutzeroberfläche.
