...
Methoden eines Controllers, welche mit \texttt{@OnShow} annotiert wurden, werden aufgerufen, wenn ein Controller im Szenengraphen enthalten ist und somit aktiv gerendert wird. Eine Priorisierung der Aufrufreihenfolge ist wie bei anderen Lebenszyklusbehandlungsannotationen ebenfalls möglich. Analog dazu werden \texttt{@OnHide} Methoden aufgerufen, wenn der Controller gewechselt wird und somit nicht mehr angezeigt wird (siehe \autoref{lst:login_controller_visibility_methods}).
