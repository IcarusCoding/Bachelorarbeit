...
\begin{table}[H]
	...
	\begin{tabular}{P{0.1\textwidth}p{0.55\textwidth}P{0.1\textwidth}P{0.1\textwidth}}
		...
		\hline
		JavaFX & Ermöglicht die Erstellung von Java Applikationen mit grafischen Oberflächen & 16 & GPLv2\tablefootnote{GPLv2 mit Linking Exception: \url{https://openjdk.java.net/legal/gplv2+ce.html}} \\
