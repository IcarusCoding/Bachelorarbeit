...
public class SimpliFXMLLoader {
    ...
    /**
     * Prefix for resource resolution without dynamic translation.
     */
    public static final String RESOURCE_KEY_NOT_DYNAMIC_PREFIX = "%!";
    /**
    ...
    static {
        ...
        SimpliFXMLLoaderHelper.setFXMLLoaderAccessor(SimpliFXMLLoader::setStaticLoad);
    }
    ...
    private SimpliFXMLLoader parentLoader;
    private XMLStreamReader xmlStreamReader = null;
    private SimpliFXMLLoader.Element current = null;
     ...
     * @since JavaFX 2.1
     */
    public SimpliFXMLLoader(URL location) {
        this(location, null);
    }
     ...
     */
    public SimpliFXMLLoader(Charset charset) {
    ...
    private static SimpliFXMLLoader.SupportedType toSupportedType(Method m) {
        for (SimpliFXMLLoader.SupportedType t : SimpliFXMLLoader.SupportedType.values()) {
    ...
    private static boolean needsClassLoaderPermissionCheck(Class caller) {
        ...
        return !SimpliFXMLLoader.class.getModule().equals(caller.getModule());
    }
    ...
    public static void setDefaultClassLoader(ClassLoader defaultClassLoader) {
        ...
        SimpliFXMLLoader.defaultClassLoader = defaultClassLoader;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SimpliFXMLLoader) {
            SimpliFXMLLoader loader = (SimpliFXMLLoader) obj;
    ...
    private boolean isCyclic(
            SimpliFXMLLoader currentLoader,
            SimpliFXMLLoader node) {
            ...
            if (controller != null) {
                if (controller instanceof Initializable) {
                    ...
                    Method initializeMethod = controllerAccessor
                            ...
                            .get(SimpliFXMLLoader.SupportedType.PARAMETERLESS)
    ...
    private String constructFXMLTrace() {
        ...
        for (SimpliFXMLLoader loader : loaders) {
        ...
        if (prefix == null) {
            ...
            if (Character.isLowerCase(localName.charAt(i + 1))) {
                ...
                if (i == -1) {
                    ...
                    current = new SimpliFXMLLoader.PropertyElement(name, null);
                } else {
                    ...
                    if (sourceType != null) {
                        ...
                        current = new SimpliFXMLLoader.PropertyElement(name, sourceType);
                    } else if (staticLoad) {
                        ...
                        current = new SimpliFXMLLoader.UnknownStaticPropertyElement();
                    } else {
                ...
                if (type != null) {
                    ...
                    current = new SimpliFXMLLoader.InstanceDeclarationElement(type);
                } else if (staticLoad) {
                    ...
                    current = new SimpliFXMLLoader.UnknownTypeElement();
                } else {
    ...
    private static class ControllerMethodEventHandler<T extends Event> implements EventHandler<T> {
        private final SimpliFXMLLoader.MethodHandler handler;

        public ControllerMethodEventHandler(SimpliFXMLLoader.MethodHandler handler) {
    ...
    private static class ObservableListChangeAdapter implements ListChangeListener {
        ...
        public ObservableListChangeAdapter(SimpliFXMLLoader.MethodHandler handler) {
            this.handler = handler;
        }
    ...
    private static class ObservableMapChangeAdapter implements MapChangeListener {
        public final SimpliFXMLLoader.MethodHandler handler;

        public ObservableMapChangeAdapter(SimpliFXMLLoader.MethodHandler handler) {
            this.handler = handler;
        }
    ...
    private static class ObservableSetChangeAdapter implements SetChangeListener {
        ...
        public ObservableSetChangeAdapter(SimpliFXMLLoader.MethodHandler handler) {
            this.handler = handler;
        }
    ...
    private static class PropertyChangeAdapter implements ChangeListener<Object> {
        ...
        public PropertyChangeAdapter(SimpliFXMLLoader.MethodHandler handler) {
            this.handler = handler;
        }
    ...
    private static class MethodHandler {
        ...
        private final SimpliFXMLLoader.SupportedType type;

        private MethodHandler(Object controller, Method method, SimpliFXMLLoader.SupportedType type) {
            this.method = method;
            this.controller = controller;
            this.type = type;
        }
        ...
        public void invoke(Object... params) {
            try {
                if (type != SimpliFXMLLoader.SupportedType.PARAMETERLESS) {
    ...
    private static final class ControllerAccessor {
        ...
        private Map<SimpliFXMLLoader.SupportedType, Map<String, Method>> controllerMethods;
        ...
        Map<SimpliFXMLLoader.SupportedType, Map<String, Method>> getControllerMethods() {
            if (controllerMethods == null) {
                controllerMethods = new EnumMap<>(SimpliFXMLLoader.SupportedType.class);
                for (SimpliFXMLLoader.SupportedType t : SimpliFXMLLoader.SupportedType.values()) {
        ...
        private void addAccessibleMethods(final Class<?> type,
            ...
            for (int i = 0; i < methods.length; ++i) {
                ...
                final SimpliFXMLLoader.SupportedType convertedType;
    ...
    private abstract class Element {
        public final SimpliFXMLLoader.Element parent;
        public final LinkedList<SimpliFXMLLoader.Attribute> eventHandlerAttributes = new LinkedList<SimpliFXMLLoader.Attribute>();
        public final LinkedList<SimpliFXMLLoader.Attribute> instancePropertyAttributes = new LinkedList<SimpliFXMLLoader.Attribute>();
        public final LinkedList<SimpliFXMLLoader.Attribute> staticPropertyAttributes = new LinkedList<SimpliFXMLLoader.Attribute>();
        public final LinkedList<SimpliFXMLLoader.PropertyElement> staticPropertyElements = new LinkedList<SimpliFXMLLoader.PropertyElement>();
        ...
        public void processInstancePropertyAttributes() throws IOException {
            if (instancePropertyAttributes.size() > 0) {
                for (SimpliFXMLLoader.Attribute attribute : instancePropertyAttributes) {
        ...
        public void processAttribute(String prefix, String localName, String value)
            ...
            if (prefix == null) {
                ...
                if (localName.startsWith(EVENT_HANDLER_PREFIX)) {
                    ...
                    eventHandlerAttributes.add(new SimpliFXMLLoader.Attribute(localName, null, value));
                } else {
                    int i = localName.lastIndexOf('.');
                    ...
                    if (i == -1) {
                        ...
                        instancePropertyAttributes.add(new SimpliFXMLLoader.Attribute(localName, null, value));
                    } else {
                        ...
                        if (sourceType != null) {
                            ...
                            staticPropertyAttributes.add(new SimpliFXMLLoader.Attribute(name, sourceType, value));
                        } else if (staticLoad) {
                            if (loadListener != null) {
        ...
        @SuppressWarnings("unchecked")
        public void processPropertyAttribute(SimpliFXMLLoader.Attribute attribute) throws IOException {
        ...
        private boolean processValue(Class sourceType, String propertyName, String aValue)
            ...
            if (!processed) {
                applyProperty(propertyName, sourceType, resolvePrefixedValue(aValue, propertyName));
                processed = true;
            }
            return processed;
        }
         ...
         */
        private Object resolvePrefixedValue(String aValue, String propertyName) throws LoadException {
            if (aValue.startsWith(ESCAPE_PREFIX)) {
                ...
                if (aValue.startsWith(RELATIVE_PATH_PREFIX)) {
                    ...
                    if (aValue.charAt(0) == '/') {
                        ...
                        try {
                            return new URL(SimpliFXMLLoader.this.location, aValue).toString();
                        } catch (MalformedURLException e) {
                            System.err.println(SimpliFXMLLoader.this.location + "/" + aValue);
                        }
                    }
                }
            } else if (aValue.startsWith(RESOURCE_KEY_NOT_DYNAMIC_PREFIX)) {
                aValue = aValue.substring(RESOURCE_KEY_NOT_DYNAMIC_PREFIX.length());
                if (aValue.length() == 0) {
                    throw constructLoadException("Missing resource key.");
                }
                if (aValue.startsWith(RESOURCE_KEY_NOT_DYNAMIC_PREFIX)) {
                    // The prefix was escaped
                    warnDeprecatedEscapeSequence(RESOURCE_KEY_NOT_DYNAMIC_PREFIX);
                    return aValue;
                } else {
            ...
            if (stringValue.length() > 0) {
                ...
                for (int i = 0; i < values.length; i++) {
                    Array.set(propertyValue, i,
                            BeanAdapter.coerce(resolvePrefixedValue(values[i].trim(), null),
        ...
        private void populateListFromString(
            ...
            if (stringValue.length() > 0) {
                ...
                for (String aValue : values) {
                    aValue = aValue.trim();
                    list.add(
                            BeanAdapter.coerce(resolvePrefixedValue(aValue, null),
                                    (Class<?>) itemType));
                }
            }
        }
        ...
        private SimpliFXMLLoader.MethodHandler getControllerMethodHandle(String handlerName,
                                                                         SimpliFXMLLoader.SupportedType... types) throws
                LoadException {
            if (handlerName.startsWith(CONTROLLER_METHOD_PREFIX)) {
                ...
                if (!handlerName.startsWith(CONTROLLER_METHOD_PREFIX)) {
                    ...
                    for (SimpliFXMLLoader.SupportedType t : types) {
                        Method method = controllerAccessor
                                .getControllerMethods()
                                .get(t)
                                .get(handlerName);
                        if (method != null) {
                            return new SimpliFXMLLoader.MethodHandler(controller, method, t);
                        }
                    }
                    Method method = controllerAccessor
                            .getControllerMethods()
                            ...
                            .get(handlerName);
                    if (method != null) {
                        return new SimpliFXMLLoader.MethodHandler(controller, method,
                                SimpliFXMLLoader.SupportedType.PARAMETERLESS);
                    }
        ...
        public void processEventHandlerAttributes() throws LoadException {
            if (eventHandlerAttributes.size() > 0 && !staticLoad) {
                for (SimpliFXMLLoader.Attribute attribute : eventHandlerAttributes) {
                    ...
                    if (value instanceof ObservableList && attribute.name.equals(COLLECTION_HANDLER_NAME)) {
                        ...
                        SimpliFXMLLoader.MethodHandler handler = getControllerMethodHandle(handlerName,
                                SimpliFXMLLoader.SupportedType.EVENT);
                        if (handler != null) {
                            eventHandler = new SimpliFXMLLoader.ControllerMethodEventHandler<>(handler);
                        }
                        ...
                        if (eventHandler == null) {
                            if (handlerName.length() == 0 || scriptEngine == null) {
                                throw constructLoadException(
                                        "Error resolving " + attribute.name + "='" + attribute.value
                                                + "', either the event handler is not in the Namespace or there is an error in the script.");
                            }
                            eventHandler = new SimpliFXMLLoader.ScriptEventHandler(handlerName, scriptEngine,
                                    location.getPath()
        ...
        private void processObservableListHandler(String handlerValue) throws LoadException {
            ...
            if (handlerValue.startsWith(CONTROLLER_METHOD_PREFIX)) {
                SimpliFXMLLoader.MethodHandler handler = getControllerMethodHandle(handlerValue,
                        SimpliFXMLLoader.SupportedType.LIST_CHANGE_LISTENER);
                if (handler != null) {
                    list.addListener(new SimpliFXMLLoader.ObservableListChangeAdapter(handler));
                } else {
        ...
        private void processObservableMapHandler(String handlerValue) throws LoadException {
            ...
            if (handlerValue.startsWith(CONTROLLER_METHOD_PREFIX)) {
                SimpliFXMLLoader.MethodHandler handler = getControllerMethodHandle(handlerValue,
                        SimpliFXMLLoader.SupportedType.MAP_CHANGE_LISTENER);
                if (handler != null) {
                    map.addListener(new SimpliFXMLLoader.ObservableMapChangeAdapter(handler));
                } else {
                    throw constructLoadException("Controller method \"" + handlerValue + "\" not found.");
                }
            } else if (handlerValue.startsWith(EXPRESSION_PREFIX)) {
        ...
        private void processObservableSetHandler(String handlerValue) throws LoadException {
            ...
            if (handlerValue.startsWith(CONTROLLER_METHOD_PREFIX)) {
                SimpliFXMLLoader.MethodHandler handler = getControllerMethodHandle(handlerValue,
                        SimpliFXMLLoader.SupportedType.SET_CHANGE_LISTENER);
                if (handler != null) {
                    set.addListener(new SimpliFXMLLoader.ObservableSetChangeAdapter(handler));
                } else {
                    throw constructLoadException("Controller method \"" + handlerValue + "\" not found.");
                }
            } else if (handlerValue.startsWith(EXPRESSION_PREFIX)) {
        ...
        private void processPropertyHandler(String attributeName, String handlerValue) throws LoadException {
            ...
            if (i != j) {
                ...
                if (handlerValue.startsWith(CONTROLLER_METHOD_PREFIX)) {
                    final SimpliFXMLLoader.MethodHandler handler = getControllerMethodHandle(handlerValue,
                            SimpliFXMLLoader.SupportedType.PROPERTY_CHANGE_LISTENER,
                            SimpliFXMLLoader.SupportedType.EVENT);
                    if (handler != null) {
                        if (handler.type == SimpliFXMLLoader.SupportedType.EVENT) {
                            ...
                            propertyModel.addListener(new SimpliFXMLLoader.PropertyChangeAdapter(handler));
                        }
                    } else {
                        throw constructLoadException("Controller method \"" + handlerValue + "\" not found.");
                    }
    ...
    private abstract class ValueElement extends SimpliFXMLLoader.Element {
        ...
        public void processEndElement() throws IOException {
            ...
            if (staticPropertyAttributes.size() > 0) {
                for (SimpliFXMLLoader.Attribute attribute : staticPropertyAttributes) {
                    processPropertyAttribute(attribute);
                }
            }
            ...
            if (staticPropertyElements.size() > 0) {
                for (SimpliFXMLLoader.PropertyElement element : staticPropertyElements) {
        ...
        private Object getListValue(SimpliFXMLLoader.Element parent, String listPropertyName, Object value) {
    ...
    private class InstanceDeclarationElement extends SimpliFXMLLoader.ValueElement {
        public Class<?> type;
    ...
    private class UnknownTypeElement extends SimpliFXMLLoader.ValueElement {
        @Override
        public void processEndElement() throws IOException {
            // No-op
        }
        ...
        public Object constructValue() throws LoadException {
            return new SimpliFXMLLoader.UnknownTypeElement.UnknownValueMap();
        }
    ...
    private class IncludeElement extends SimpliFXMLLoader.ValueElement {
        ...
        public Object constructValue() throws IOException {
            ...
            if (source.charAt(0) == '/') {
                ...
                location = new URL(SimpliFXMLLoader.this.location, source);
            }

            SimpliFXMLLoader fxmlLoader = new SimpliFXMLLoader(location, resources,
                    builderFactory, controllerFactory, charset,
                    loaders);
            fxmlLoader.parentLoader = SimpliFXMLLoader.this;

            if (isCyclic(SimpliFXMLLoader.this, fxmlLoader)) {
                throw new IOException(
                        String.format(
                                "Including \"%s\" in \"%s\" created cyclic reference.",
                                fxmlLoader.location.toExternalForm(),
                                SimpliFXMLLoader.this.location.toExternalForm()));
            }
    ...
    private class ReferenceElement extends SimpliFXMLLoader.ValueElement {
        public String source = null;
    ...
    private class CopyElement extends SimpliFXMLLoader.ValueElement {
        public String source = null;
    ...
    private class RootElement extends SimpliFXMLLoader.ValueElement {
    ...
    private class PropertyElement extends SimpliFXMLLoader.Element {
        public final String name;
        public final Class<?> sourceType;
    ...
    private class UnknownStaticPropertyElement extends SimpliFXMLLoader.Element {
    ...
    private class ScriptElement extends SimpliFXMLLoader.Element {
        public String source = null;
        public Charset charset = SimpliFXMLLoader.this.charset;
    ...
    private class DefineElement extends SimpliFXMLLoader.Element {
        @Override
        public boolean isCollection() {
            return true;
        }
